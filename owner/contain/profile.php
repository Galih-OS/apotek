	...
	<div class="row">
	  ...
	  <div class="col-md-10">
		<form action="" method="POST">
			  ...
			  <div class="form-group">
				<label for="jumlah">Confirm Password</label>
		...
		<form action="" method="POST">
			...
			?>
			  ...
			  <div class="form-group">
				...
				<input type="text" class="form-control" disabled name="status_pengguna" value="<?php  echo $data['status_pengguna']; ?>">
			  </div>
			  <div class="form-group" align="right">
...
<?php
	...
	if(isset($_POST['change_password']))
	{
		...
		$query_pass = mysql_query("SELECT password AS pass FROM pengguna
					...
					$pass = $pass['pass'];
		if ($old_pass == base64_decode($pass)){
