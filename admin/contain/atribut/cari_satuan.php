  ...
  <div class="form-group">
	<div class="col-sm-8 col-md-6 col-xs-8">
		<div class="input-group">
			...
			<input type="text" class="form-control input-lg" name="pencarian" placeholder="Pencarian Nama Satuan" autofocus>
		</div>
	</div>
	...
	<div class="col-sm-12 col-md-2 col-xs-12" style="margin-top:0px;" align="right">
		<button type='submit' name='tambah_satuan' class='btn btn-success btn-lg btn-block'>Tambah Satuan</button>
	</div>
  </div>
</form>