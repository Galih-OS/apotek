<form class="form-horizontal" action="" method="POST">
  <div class="form-group">
		...
		<div class="input-group">
			<div class="input-group-addon">
				<span class="fa-stack fa-1x">
					<i class="fa fa-search fa-stack-1x fa-inverse" style="color:black;"></i>
				</span>
			</div>
			<input type="text" class="form-control input-lg" name="pencarian" placeholder="Pencarian Nama Supplier" autofocus>
		</div>
	</div>
	...
	<div class="col-sm-12 col-md-2 col-xs-12" style="margin-top:0px;" align="right">
		<button type="button" class="btn btn-success btn-lg btn-block" data-toggle="modal" data-target="#ModalTambahSupplier">
		  Tambah Supplier
		</button>
	</div>
  </div>
