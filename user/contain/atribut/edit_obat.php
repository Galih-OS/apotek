		  ...
		  <div class="panel-body">
			<form action="" method="POST">
				  ...
				  <div class="form-group">
					...
					<input type="text" class="form-control" name="jumlah" value="<?php echo $list['jumlah_stok']; ?>">
				  </div>
				  <div class="form-group">
				  ...
				  <div class="form-group">
					...
					<input type="text" hidden name="harga_beli" value="<?php echo $list['harga_beli']; ?>">
					<input type="text" class="form-control" disabled name="harga_beli" value="<?php echo $list['harga_beli']; ?>">
				  </div>
				  <div class="form-group">
					<label for="username">Harga Jual</label>
					<input type="text" class="form-control" name="harga_jual" value="<?php echo $list['harga_jual']; ?>">
				  </div>
			<div align="right">
